...
class MenuController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        $menus = [
            ...
            ['id' => 'leave-entitlements', 'module' => 'leaveEntitlements', 'label' => 'Leave Entitlements', 'routePath' => '/masters/leave-entitlements', 'view' => 'view leave entitlements', 'edit' => 'edit leave entitlements', 'delete' => 'delete leave entitlements'],
            // Capability flag: view = the `create leave entitlements` permission.
            ['id' => 'leave-entitlements-create', 'module' => 'leaveEntitlementsCreate', 'label' => 'Create Leave Entitlements', 'routePath' => '/masters/leave-entitlements', 'view' => 'create leave entitlements', 'edit' => null, 'delete' => null],
            ['id' => 'holidays', 'module' => 'holidays', 'label' => 'Holidays', 'routePath' => '/masters/holidays', 'view' => 'view holidays', 'edit' => 'edit holidays', 'delete' => 'delete holidays'],
            // Capability flag: view = the `create holidays` permission.
            ['id' => 'holidays-create', 'module' => 'holidaysCreate', 'label' => 'Create Holidays', 'routePath' => '/masters/holidays', 'view' => 'create holidays', 'edit' => null, 'delete' => null],
